...
project = 'mcnntunes'
copyright = '2020, Marco Lazzarin, Simone Alioli, Stefano Carrazza'
author = 'Marco Lazzarin, Simone Alioli, Stefano Carrazza'

# The full version, including alpha/beta/rc tags
release = mcnntunes.__version__
autodoc_mock_imports = ['yoda']
